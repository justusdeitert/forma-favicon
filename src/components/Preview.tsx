...
import { ADDITIONAL_FILES, PREVIEW_SIZES } from '../constants';
				...
				{PREVIEW_SIZES.map(({ file, label, desc }) => (
					...
					>
						...
						<div className="w-full text-center min-w-0">
							...
							<div className="text-[10px] text-gray-400 truncate" title={desc}>
								{desc}
							</div>
							<div className="text-[10px] text-gray-400 font-mono truncate mt-1" title={file}>
								{file}
							</div>
						</div>
					</div>
