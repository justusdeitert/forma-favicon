...
export const BrowserTabPreview = ({ faviconUrl, cacheBuster, livePreviewUrl, dark = false }: Props) => {
	...
	return (
		<div className="mb-6">
			<p className="text-xs text-gray-400 m-0 mb-4">How your favicon looks in a browser tab and as an app icon.</p>
