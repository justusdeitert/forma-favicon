			...
			<div className="flex items-start gap-3">
				...
				<div className="flex-1">
					...
					<p className="text-xs text-amber-600 m-0 mb-4">
						The following {conflicts.length === 1 ? 'plugin conflicts' : 'plugins conflict'} with Forma Favicon and may
						cause unexpected behavior. Please deactivate and remove {conflicts.length === 1 ? 'it' : 'them'} from the{' '}
