		...
		<div className="mb-8 p-5 bg-amber-50 border-2 border-amber-200 rounded-xl">
			<div className="flex items-start gap-3">
				...
				<div className="flex-1">
					<h2 className="text-sm font-semibold text-amber-800 m-0 mb-1">WordPress Site Icon is also set</h2>
					<p className="text-xs text-amber-600 m-0 mb-4">
						A Site Icon is configured in WordPress Settings → General. While Forma Favicon overrides it, we recommend
